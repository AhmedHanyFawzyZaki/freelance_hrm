...
class BlogPostController extends AdminController {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['BlogPost'])) {
            ...
            if (!empty($uploadedFile)) {
                ...
                $uploadedFile->saveAs(Yii::app()->basePath . '/../media/blog/' . $fileName);
            }
            if ($model->save())
        ...
        if (isset($_POST['BlogPost'])) {
            ...
            if (!empty($uploadedFile)) {
                if ($model->image == '') {
                    ...
                    unlink(Yii::app()->basePath . '/../media/blog/' . $model->image);
                    $rnd = time();
                    $fileName = "{$rnd}-{$uploadedFile}";
                    $model->image = $fileName;
                }
                $uploadedFile->saveAs(Yii::app()->basePath . '/../media/blog/' . $model->image);
            }
            if ($model->save())
                $this->redirect(array('view', 'id' => $model->id));
        }
    ...
    public function actionIndex() {
        ...
        if (isset($_GET['active'])) {
            $_GET['BlogPost']['active'] = $_GET['active'];
        }
